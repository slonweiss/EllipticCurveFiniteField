...
WeierstrassCurvePlot[iterations_, primes_, iterRev_, rotation_] := Module[{c, a, p, xTorus, yTorus, zTorus, aCoeff, bCoeff, xElliptic, yElliptic, xMapped, yMapped, zMapped, fieldPoints, uMap, vMap, meshPoints, lines, labelPos, pointsOnCurve, mappedCurvePoints, myPlot, x, y, y2, i, revs},
...
Show[
  Graphics3D[
  {White, Opacity[0.05], Torus[{0, 0, 0}, {1, 1}]}
  ], 
  Graphics3D[
    {
      Directive[White], 
...
If[revs > 0,
  ...
  ViewPoint -> RotationTransform[rotation, {0, 0, 1}][{1.3, -2.5, 2.0}],  (* Adjust this line *)
  ViewVertical -> {0, 0, 1},
  PlotRange -> All,
