...
Show[
  ParametricPlot3D[
    ...
    {u, 0, 2 Pi}, 
    {v, -Pi, Pi}, 
    PlotStyle -> Directive[White, Opacity[0.1]], 
    Mesh -> 17,
    MeshStyle -> Directive[Opacity[0.5]],
    Lighting -> "Neutral"
  ], 
  ParametricPlot3D[
  ...
  Background -> Black(*,
  Epilog -> {
    Inset[Style["Size of finite field: p =" <> ToString[p], 16], Scaled[{0.5, 0.1}]],
    Inset[Style["Order of the curve = " <> ToString[numMappedCurvePoints + 1], 16], Scaled[{0.5, 0.05}]]
  }*)
]
]

WeierstrassCurvePlot[1, 17]
