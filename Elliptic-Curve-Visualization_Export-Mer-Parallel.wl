...
If[revs > 0,
  ...
  ParametricPlot3D[
    ...
    {v, -Pi, Pi}, 
    PlotStyle -> Directive[Magenta, Opacity[0.5], Thickness[0.005]]
  ],
  (*Parallel lines*)
  Table[
    ParametricPlot3D[
      {xTorus[u, v], yTorus[u, v], zTorus[u, v]}, 
      {v, -Pi, Pi}, 
      PlotStyle -> Directive[White, Opacity[0.2], Thickness[0.003]]
    ],
    {u, 0, 2 Pi, 2 Pi/(p - 1)}
  ],
  ...
  ParametricPlot3D[
    ...
    {u, 0, 2 Pi}, 
    PlotStyle -> Directive[Red, Opacity[0.5], Thickness[0.005]]
  ],
    (*Meridian lines*)
  Table[
    ParametricPlot3D[
